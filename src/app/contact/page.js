    ...
    <div>
      <section className="border-b border-gray-200 bg-white">
        <div className="arena-container py-16 md:py-20">
          <p className="arena-eyebrow">Contact AutoHaus Style</p>
          <h1 className="arena-title">Kontakt Arena Motors</h1>
      ...
      <section className="arena-section">
        <div className="arena-container grid gap-8 lg:grid-cols-[1.1fr_1fr]">
          <div className="arena-card p-8">
            ...
            <div className="mt-6 grid gap-4 text-sm text-gray-700 md:grid-cols-2">
              <div>
                ...
                <p className="mt-1 font-medium">Ive Andrića 6, 71123 I. Sarajevo, BiH</p>
              </div>
              <div>
                <p className="text-gray-500">Telefon</p>
                <p className="mt-1 font-medium">Saša: +387 66 444 016</p>
                <p className="font-medium">Dijana: +387 66 444 644</p>
              </div>
              <div>
                <p className="text-gray-500">Email</p>
                <p className="mt-1 font-medium">info@arenamotors.ba</p>
              </div>
              <div>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm outline-none"
                />
                <button type="submit" className="arena-btn-primary w-full">Submit</button>
              </form>
            )}
          </div>
        </div>
      ...
      <section className="arena-section bg-white">
        <div className="arena-container">
          <div className="arena-card overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3639.157636597384!2d18.362079076708138!3d43.827942541110595!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4758c97a09528729%3A0xbd6471b0f460dfd2!2sArena%20Motors%20-%20Auto%20salon%20Sarajevo!5e1!3m2!1sen!2sba!4v1759753805447!5m2!1sen!2sba"
              style={{ width: "100%", height: 430, border: 0 }}
              allowFullScreen
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
              title="Arena Motors map"
            />
          </div>
        </div>
      </section>
