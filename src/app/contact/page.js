                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Bulevar Meše Selimovića 12</p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Pon - Pet: 09:00 - 18:00</p>
                            ...
                            <div className="pt-8 border-t border-gray-200">
                                ...
                                <div className="flex gap-4">
                                    <a href="#" className="w-12 h-12 bg-gray-100 hover:bg-red-600 rounded-xl flex items-center justify-center transition-all group">
