                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="pt-8 border-t border-gray-200">
                                ...
                                <div className="flex gap-4">
                                    <a href="https://www.instagram.com/arena_motors_sarajevo/?hl=en" className="w-12 h-12 bg-gray-100 hover:bg-red-600 rounded-xl flex items-center justify-center transition-all group">
                                        <Instagram />
                                    </a>
                                    <a href="https://www.facebook.com/arenasarajevo/" className="w-12 h-12 bg-gray-100 hover:bg-blue-600 rounded-xl flex items-center justify-center transition-all group">
                                        <Facebook />
                                    </a>
                                </div>
                            </div>
                    ...
                    <div className="rounded-3xl overflow-hidden shadow-2xl h-96 bg-gray-300">
                        ...
                        <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-200 to-gray-300">
                            <div className="text-center">
                                ...
                                <p className="text-gray-600 text-lg font-semibold">Google Maps integracija</p>
                                <p className="text-gray-500 text-sm">Bulevar Meše Selimovića 12, Sarajevo</p>
                            </div>
                        </div>
                    </div>
                </div>
