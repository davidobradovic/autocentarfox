            ...
            <div className="bg-white rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100">
                ...
                <div className="relative aspect-video bg-gray-100 overflow-hidden">
                    ...
                    {vehicle.premium_badges?.length > 0 && (
                        <div className="absolute top-2 right-2 flex flex-col gap-1">
                            {vehicle.premium_badges.map((badge, i) => (
                                <span
                                    key={i}
                                    className="text-[10px] font-semibold px-2 py-0.5 rounded border shadow"
                                    style={{
                    ...
                    <div className="absolute top-2 left-2 flex gap-1">
                        ...
                        <span className="bg-white/95 text-gray-900 text-xs font-medium px-1.5 py-0.5 rounded shadow-md">
                            {vehicle.state === 'used' ? 'Polovno' : 'Novo'}
                        </span>
                    </div>
                </div>
                ...
                {/* Content */}
                <div className="p-2.5">
                    <h3 className="text-sm font-bold text-gray-900 mb-2 line-clamp-2">{vehicle.title}</h3>
